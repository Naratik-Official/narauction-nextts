...
export default function Catalog() {
    ...
    useEffect(() => {
        const fetch = async () => {
            const { data: events } = await axios.get("https://narauction.et.r.appspot.com/event");
            ...
            <Grid container className={styles.root}>
                ...
                <h3 className="no-bold">{t("catalog_header_subtitle")}</h3>
                    ...
                    <CustomSlider
                        ...
                        slidesToShow={Math.min(Math.max(Object.entries(barangEvents).length, 1), 3)}
                        ref={sliderRef}
                    >
                  ...
                  url(${e.foto[0]})`,
                                    ...
                                    <div className={styles.sliderContent}>
                                        ...
                                        <div className={styles.subcontainer}>
                                            ...
                                            <p className="extra-small">
                                                LIVE auction{" "}
                                                {moment(e.date).format("dddd, D MMMM y")} at{" "}
                                                {moment(e.date).format("h:m A")}
                                            </p>
                                        </div>
                    ...
                    {activeEventId && (
                        <Grid container spacing={3}>
                            {barangEvents[activeEventId].barang.length > 0 && !fetchingBarang ? (
