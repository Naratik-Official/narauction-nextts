...
export default function GuidelinesAuctioneers1() {
  return (
    <Grid container>
      <GuidelinesHeader />
      <Grid item xs={1} />
      <Grid item xs={10}>
        <main className={styles.root}>
          ...
          />
          <p>
            3 Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ipsum
            ...
            pretium. Integer nibh malesuada at magna orci, aliquam. Turpis morbi
            diam vestibulum tempor sit mattis faucibus. Ornare dui sed odio
            turpis nec. At pretium sed augue cursus leo commodo maecenas. Ornare
            quisque egestas in morbi faucibus in sed quam malesuada. Sit lacus
            vulputate venenatis id tincidunt pharetra.
            {'\n\n'}
            ...
            rhoncus nisi, amet, mauris. Adipiscing mi, consequat mi quis varius
            morbi ligula ullamcorper. Nec sollicitudin tristique amet mattis
            nunc viverra tincidunt. Mauris pretium tempus vestibulum nulla.
            Fames viverra adipiscing eleifend lacus. Aliquet egestas blandit
            gravida iaculis nullam in quam. {'\n\n'}
            ...
            Et viverra tristique fusce vestibulum vitae massa, auctor magna. Vel
            leo vitae aliquam, mattis. Et diam magna dui consectetur purus
            pretium leo. {'\n\n'}
            ...
            Fermentum ornare nunc id nisl rutrum. Diam magna elit vel convallis
            arcu mi vestibulum vitae. Sagittis fusce ornare lacus, fusce quam
            interdum. Tellus lobortis dictum fringilla purus tellus quam eget.
            Risus eu netus.
          </p>
        </main>
      </Grid>
