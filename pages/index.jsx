        ...
        <Grid container component="section" className={styles.testimonials}>
          ...
          <Grid item xs={10}>
              ...
              {Array.from({ length: 6 }).map((_, e) => (
                <div key={e}>
                  ...
                  <div className={styles.sliderContent}>
                    <RatingStars rating={5 - e} />
                    <p>
                      “ Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Aliquam vestibulum, elementum nisi, quisque. Volutpat
                      lacus donec dui ullamcorper fermentum quis.”
                    </p>
                    <h5>Name - City</h5>
                  </div>
                </div>
            ...
            <div className={styles.register}>
              <h4 className="white">Register For Free & Start Bidding Now!</h4>
